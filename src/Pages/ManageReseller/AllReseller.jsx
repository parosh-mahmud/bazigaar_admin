...
const tableHead = [
  ...
  { id: 2, name: "Reseller", width: 40 },
  { id: 3, name: "Reseller Name", width: 220 },
...
const AllReseller = ({ isLoading, setIsLoading }) => {
  ...
  return (
    <Fragment>
      <PrimaryLayout pageTitle="Manage Reseller">
